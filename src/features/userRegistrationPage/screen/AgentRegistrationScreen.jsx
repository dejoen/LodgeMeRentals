    ...
    <div className="font-nunito w-full flex  md:justify-center ">
      <div className="w-full md:w-[50%]  md:p-12 flex flex-col   place-items-center justify-center overflow-auto">
        <div className="w-full">
          <img
            className="w-[20px]   font-bold ms-5 mt-5"
            src={backArrowIcon}
            onClick={() => {
              navigate("/");
            }}
        ...
        <div className="w-full mt-5 flex flex-col place-items-center gap-5">
          ...
          <div>
            ...
            <div className="w-fit border border-black rounded-md  flex p-3">
              <input
                ...
                type="tel"
                placeholder="+234"
                value={registrationData.userPhoneNumber}
                onChange={(e) => {
                  setRegistrationData((prevState) => {
                    return {
                      ...prevState,
          ...
          <div>
            ...
            <div className="w-fit border border-black rounded-md  flex p-3">
              <input
                className="outline-none"
                type={togglePassword.confirmPassword.isToggle ? "text" : "password"}
                value={togglePassword.confirmPassword.password}
          ...
          <div className="flex  w-[300px] ms-4">
            ...
            <p className="text-center mt-2">
              By clicking you confirm that you have read, understood, and agree to be bound by our{" "}
              <span className="underline">Terms</span> and <span className="underline">Conditions</span>
            </p>
          </div>

          <div>
            <div
              className="w-[200px] border bg-orange-400 rounded-md  flex place-items-center justify-center  p-3 mb-5"
              onClick={async () => {
                //openErrorScreen()
                ...
                if (
                  ...
                  !registrationData.userPhoneNumber ||
                ...
                if (!registrationData.userAgreeToTerms) {
                  setErrorMessage(
                    "please click the check box to confirm that you agreed to LodgeMe terms and conditions.",
                  );
                  openErrorScreen();
                  return;
                }
      ...
      <div className="hidden md:flex w-[50%] h-[500px] sticky top-20  ms-[10%] me-[10%] bottom-0  bg-agentSignUpBackgroundImage  bg-cover bg-center  bg-no-repeat rounded-md place-items-end justify-center pb-5">
        <p className="bg-black text-white bg-opacity-25 font-bold text-2xl p-2">
          Provide High Quality Homes for your clients.
        </p>
      </div>

      <ErrorPopUpScreen
        title={"Registration Message"}
        body={errorMessage ? errorMessage : "you  can not access dashboard without registering"}
      />
      ...
      {!agentReducerState.isLoggedIn && agentReducerState.showPopUp ? (
        <ErrorPopUpScreen
          title={"Registration Message"}
          body={errorMessage ? errorMessage : "you  can not access dashboard without registering"}
          display={openErrorScreenState ? "flex" : "hidden"}
          openScreen={() => {
