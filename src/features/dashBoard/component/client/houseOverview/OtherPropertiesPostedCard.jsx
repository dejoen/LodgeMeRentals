...
const OtherPropertiesPostedCard = () => {

    return (
        <div className="font-nunito  inline-block ml-3 md:ml-0 w-[100%] mx-auto md:w-[350px] h-[350px] bg-[#7E7373] rounded-md p-3 text-white  ">
...
export default OtherPropertiesPostedCard