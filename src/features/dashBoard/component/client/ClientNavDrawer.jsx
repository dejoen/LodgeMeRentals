...
const ClientNavDrawer = (props) => {
    ...
    <div className="ClientNavBar  md:hidden w-[300px] rounded-l-2xl absolute bg-white  shadow-md shadow-black top-0 bottom-0 right-0 z-[1000] overflow-y-auto overflow-x-hidden ">
      ...
      <div className=''>
            <img className='w-[60px]  md:w-[40px]  h-[68px]
       ...
       <div className=' border-b border-black p-1' >  
            ...
            <p className='flex items-center gap-1 text-xl pb-4 pl'>Account <span className='animate-pulse' onClick={()=>{
                setActiveCard((prev)=>{
                     return {
                        ...prev,
                        accountCard:{
            ...
            }} >{(activeCard.accountCard.isActive)?   <ChevronDown className='pt-1'/>: <ChevronRight className='pt-1'/>}</span></p>
        ...
        <div className=' border-b border-black p-1'>
            ...
            <p className='flex items-center  text-xl pb-4'>Inbox<span className='animate-pulse' onClick={()=>{
    ...
    return {
       ...
       notificationCard:{
           isActive:false
            ...
            }}>{(activeCard.inboxCard.isActive)?   <ChevronDown className='pt-1'/>: <ChevronRight className='pt-1'/>}</span></p>
            <div>
      ...
      {/*}  <div className=' border-b border-black p-1'>
       ...
       setActiveCard((prev)=>{
        ...
        <div>
            ...
            <p  className='flex items-center  text-xl pb-4'>Notification<span className=''>{'(0)'}</span>
             <span className='animate-pulse' onClick={()=>{
            ...
            }}>{(activeCard.notificationCard.isActive)?   <ChevronDown  className='pt-1'/>: <ChevronRight className='pt-1'/>}</span></p>
            <div className=''>
