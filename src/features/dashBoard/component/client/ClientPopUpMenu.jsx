...
const ClientPopUpMenu = (props) => {
  return (
    <div className="hidden md:block">
      <div
        className={`${props.isMenuClosed ? "hidden" : "block"}  h-[400px] absolute right-5 z-50 flex  justify-end gap-5`}
      >
        ...
        {props.iconHovered.appointmentCard.isHover ? (
          <AppointmentCard display={"flex"} />
        ) : (
          <AppointmentCard display={"hidden"} />
        )}

        {props.iconHovered.notificationCard.isHover ? (
