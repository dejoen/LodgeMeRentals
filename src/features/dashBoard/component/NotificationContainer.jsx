  ...
  return (
    <div className=" mt-[30%] md:ml-[22%] md:mt-[10%]">
      ...
      <div className="m-10 h-[500px] overflow-x-auto ">
            ...
            {
               updatedNotification && updatedNotification.length>0 && updatedNotification.map((notification,i)=>(

                    <NotificationCard key={i} title={notification.notificationTitle}  body={notification.notificationBody} time={notification.notificationTime} type={notification.notificationType} sender={notification.senderId}/>
