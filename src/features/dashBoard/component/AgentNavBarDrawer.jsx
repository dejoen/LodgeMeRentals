...
const AgentNavBarDrawer = React.memo(() => {
  ...
  return (
    <div className="AgentDrawer absolute hidden top-0 right-0 z-[80] md:hidden bg-agentNavbarBgImage w-[250px] h-dvh ">
      ...
      <div className="font-nunito text-white flex flex-col gap-2">
        <div
          className={`flex h-[50px] hover:bg-[#BB7655] ${activeContainer.dashboardNav.isActive ? "bg-[#BB7655] " : ""} rounded-md place-items-center  ps-4 gap-2`}
          onClick={() => {
        ...
        <div
          className={`flex h-[50px] hover:bg-[#BB7655] ${activeContainer.profileNav.isActive ? "bg-[#BB7655] " : ""} rounded-md place-items-center  ps-4 gap-2`}
          onClick={() => {
            setActiveContainter((prevState) => {
              return {
                ...prevState,
        ...
        <div
          className={`flex h-[50px] hover:bg-[#BB7655] ${activeContainer.messageNav.isActive ? "bg-[#BB7655] " : ""}  rounded-md place-items-center  ps-4 gap-2`}
          onClick={() => {
            setActiveContainter((prevState) => {
              return {
                ...prevState,
   ...
   *    <div className={`flex h-[50px] hover:bg-[#BB7655] ${ (activeContainer.requestNav.isActive) ?"bg-[#BB7655] ":""}  rounded-md place-items-center  ps-4 gap-2`} onClick={()=>{
        ...
        */}
        ...
        <div
          className={`flex h-[50px]  hover:bg-[#BB7655] ${activeContainer.notificationNav.isActive ? "bg-[#BB7655] " : ""}rounded-md place-items-center  ps-4 gap-2`}
          onClick={() => {
            setActiveContainter((prevState) => {
              return {
                ...prevState,
