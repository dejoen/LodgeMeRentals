...
const UserProfileBodyContainer = () =>{
    ...
    return (
      <div className="w-full cursor-default ">
        ...
        <div className="place-self-end bg-[#1C2E7A] text-white p-1 rounded-md text-sm">
          <p>Edit</p>
        ...
        A Profile description of agent goes here, and should not be more than 70 Characters
          A Profile description of agent goes here, and should not be more than 70 Characters
          A Profile description of agent goes here, and should not be more than 70 Characters
          A Profile description of agent goes here, and should not be more than 70 Characters
          A Profile description of agent goes here, and should not be more than 70 Characters
