import { CircleUserRound, Paperclip, CirclePlus, Search, SquareMenu  } from 'lucide-react';
const  MessagesBodyContainer = () => {
    return (
    <div className="mx-auto p-3 md:p-8  mt-[90px] md:w-[90%] h-fit  rounded-2xl m-5 md:shadow-2xl shadow-black">
...
<div className='flex items-center justify-between gap-2 bg-white p-2 rounded md:flex-row flex-col'>
<CircleUserRound  className='size-14'/>
