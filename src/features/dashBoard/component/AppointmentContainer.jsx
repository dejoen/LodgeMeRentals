        ...
        {viewTypes === "active" ? (
              ...
              <div className="grid text-sm md:grid-cols-2 grid-cols-1 mx-auto w-[90%] md:w-[100%] lg:grid-cols-4 mt-5 gap-4">
                {appointmentss.morning.map((appointment, index) => (
                  <div
                    ...
                    className="flex justify-center bg-morningBg w-fit py-6 px-6 rounded-lg items-center gap-5 cursor-pointer"
                  >
                    <img
                      src={appointment.image}
                      className="size-14 border-black rounded-full border-2"
            ...
            <div className="grid md:grid-cols-2 text-sm grid-cols-1 mx-auto w-[90%] md:w-[100%] lg:grid-cols-4 mt-5 gap-4">
              {appointmentss.afternoon.map((appointment, index) => (
                <div
                  key={index}
                  onClick={() => handleCardClick(appointment)}
                  className="flex justify-center bg-afternooBg w-fit py-6 px-6 rounded-lg items-center gap-5 cursor-pointer"
                >
                  <img
                    src={appointment.image}
                    className="size-14 border-black rounded-full border-2"
            ...
            <div className="grid md:grid-cols-2 text-sm grid-cols-1 mx-auto w-[90%] md:w-[100%] lg:grid-cols-4 mt-5 gap-4">
              {appointmentss.late.map((appointment, index) => (
                <div
                  key={index}
                  onClick={() => handleCardClick(appointment)}
                  className="flex justify-center bg-otherBg w-fit py-6 px-6 rounded-lg items-center gap-5 cursor-pointer"
                >
                  <img
                    src={appointment.image}
                    className="size-14 border-black rounded-full border-2"
          ...
          <div className="grid md:grid-cols-2 text-sm grid-cols-1 mx-auto w-[90%] md:w-[100%] lg:grid-cols-4 mt-5 gap-4">
            {appointmentss.canceled.map((appointment, index) => (
              <div
                key={index}
                onClick={() => handleCardClickCancel(appointment)}
                className="flex justify-center bg-otherBg w-fit py-6 px-6 rounded-lg items-center gap-5 cursor-pointer"
              >
                <img
                  src={appointment.image}
      ...
      {showMainModals && selectedAppointments && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-end z-50 overflow-y-scroll">
          <div className="bg-white w-full md:w-[80%]   h-fit transform transition-transform duration-300 ease-in-out animate-slide-in">
            <button
              onClick={() => setShowMainModals(false)}
              className=" md:p-2  p-1 rounded-full md:m-8 m-4 text-red-600 border border-red-600"
            >
              {" "}
            ...
            <div className="w-[90%] md:w-[80%] mx-auto mt-6 md:mt-0">
              <div className=" flex justify-between items-center">
                <div className="flex items-center gap-4 ">
                  <img
                    ...
                    className="md:size-20 size-12  border-black rounded-full border-2"
                    alt={selectedAppointment.name}
                  />
                  <div>
                    {" "}
                    <h2 className="md:text-xl text-md font-bold text-center">{selectedAppointment.name}</h2>
                    <p className="text-center md:text-base text-sm text-gray-600">
                      {selectedAppointment.time} - {selectedAppointment.location}
                    </p>
                  </div>
                </div>
                <h3 className="md:text-lg text-sm">
                  House Type : <span className="font-bold">School Hostel</span>{" "}
                </h3>
              </div>
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className={`underline text-sm ${
                          reminderSent ? "text-gray-400 cursor-not-allowed" : "text-blue-700 hover:text-blue-900"
                        }`}
                      >
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center gap-8 mt-3 w-[80%] md:flex-row flex-col ">
                  ...
                  <video
                    controls
                    className="md:w-[400px] h-auto rounded-lg"
                    preload="auto"
          ...
          <div className="bg-white w-full md:w-[80%]   h-fit transform transition-transform duration-300 ease-in-out animate-slide-in">
            ...
            <div className="w-[90%] md:w-[80%] mx-auto mt-6 md:mt-0">
              ...
              <button
                ...
                className="bg-button text-white py-2 rounded-lg w-[80%] mt-12 md:w-[30%]"
              >
                Mark As Completed
              </button>
              <div className="flex flex-col md:flex-row justify-end gap-8 my-12">
                <button onClick={handleReschedule} className="bg-black text-white py-2 rounded-lg w-[20%]">
                  Reschedule
                </button>
                <button onClick={handleCancel} className="bg-red-600 text-white py-2 rounded-lg w-[25%]">
                  Cancel Appointment
                </button>
              </div>
            </div>
                ...
                <div className="w-[85%] mx-auto flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-3 text-sm">
                    ...
                    <input
                      ...
                      className=" outline-none px-4 py-2 border rounded-lg border-gray-500 text-sm"
                    />
                    <input
                      type="text"
                  ...
                  <div className="flex gap-3 mt-4">
                    <button type="submit" className="bg-button text-white py-2 px-4 rounded-lg flex-1">
                      Submit
                    </button>
                    <button
                      type="button"
            ...
            <div className="p-6 text-center flex flex-col gap-4 justify-center items-center w-[80%] mx-auto">
              ...
              <div className="flex gap-8 mt-10">
                <button
                  ...
                  className="bg-green-600 md:w-[20%] text-white py-2 px-4 rounded-lg flex-1"
                >
                  Proceed
                </button>
                <button
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3
                className={`text-2xl font-bold mb-2 ${
                  successDetails.type === "cancel" ? "text-red-600" : "text-green-600"
                }`}
              >
                {successDetails.message}
              </h3>

              <p className=" text-lg mb-2">{successDetails.subMessage}</p>
              <p className=" text-sm mb-6">{successDetails.subMessages}</p>
            </div>
          </div>
        </div>
      )}
