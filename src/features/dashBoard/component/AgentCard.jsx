...
import { useNavigate } from "react-router-dom";
 ...
 const AgentCard = (props) => {
    ...
    return (
        <div className=" font-nunito  w-full  p-3 md:w-[370px] md:h-[200px] bg-white shadow-sm shadow-black hover:shadow-xl    rounded-3xl m-2 flex flex-col place-items-center  md:flex-row gap-3 "  onClick={()=>{
            switch (props.header){
