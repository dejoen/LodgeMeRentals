      ...
      <div className="w-full h-dvh  md:flex flex-wrap justify-center  pb-12 font-nunito relative">
         ...
         */}
          ...
          <div className="text-sm space-y-3 mt-3">
            ...
            <p className="flex gap-2">
              Date Of Birth:{" "}
              <span>{state.data && state.data.userProfile.dob ? state.data.userProfile.dob : "Nil"}</span>
            </p>
            <p className="flex gap-2">
              Address:{" "}
              <span>
                {state.data && state.data.userProfile.localGovt ? state.data.userProfile.localGovt : ""},
                {state.data && state.data.userProfile.state ? state.data.userProfile.state : "Nil"}
              </span>
            </p>
          </div>
          <div
