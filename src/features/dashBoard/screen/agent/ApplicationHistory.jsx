export default function ApplicationHistor() {
  return (
    <div className="mx-auto p-3 md:ml-[22%] md:p-8  w-[95%] md:w-[75%] h-fit  rounded-2xl m-5 md:shadow-2xl  shadow-black">
      ...
      <p className="text-sm pt-4 md:w-[70%]">
        Welcome to Your Next Big Step in Homeownership or Renting! We are excited to help you find your dream home or
        ideal rental space. This application page is your gateway to accessing tailored property options, connecting
        with trusted landlords, and starting a seamless rental journey. Let us make your house hunt effortless and
        enjoyable!
      </p>
      ...
      <p className="text-sm pt-4 md:w-[70%] font-bold">
        Ready to apply for your perfect property? Fill out the application form with your details to kickstart the
        process. We’ve designed this page to be quick, simple, and secure, ensuring your information is protected while
        we match you with the best available homes.
      </p>
        ...
        <div className="flex md:items-center gap-3 md:gap-12 md:flex-row flex-col">
          <div className="flex flex-col gap-2">
            ...
            <input
              type="text"
              name="first-name"
              className="outline-none border border-gray-400 py-1 px-4 rounded-lg md:w-72"
            />
          </div>
      ...
      <div className="flex justify-end">
        {" "}
        <button className="font-bold text-md pt-10"> Next Page</button>
      </div>
    </div>
  );
}
