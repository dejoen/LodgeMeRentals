...
const FAQScreen = () => {
  return (
    <div>
      <NavBarComponent
        image={"bg-faqBackgroundImage"}
        text={"More Than Just A House, We Provide Homes"}
        textSize={"text-4xl"}
      ...
      <div className="w-full font-nunito font-bold mt-8  flex place-items-center justify-center">
        <p className="w-[200px] md:w-[260px]">
          Thank you for choosing LodgeMe. We look forward to helping you with all your real rental needs!
        </p>
      </div>
      <FooterScreen />
      <NavDrawerBar />
