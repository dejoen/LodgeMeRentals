...
const AboutContactUs = () => {
  return (
    <div className="font-nunito mt-2 w-[90%] md:w-[70%] mx-auto flex flex-col place-items-center justify-center">
      ...
      <p className="text-center font-bold leading-[30px]">
        Ready to find your next home? Get in touch with us today to start your property search journey. Whether you’re
        looking to rent or buy, we’re here to help you every step of the way.
      </p>
