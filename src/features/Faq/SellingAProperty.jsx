...
import FaqCard from "../landingPage/component/FaqCard";
 ...
 const SellingAProperty = () =>{
   ...
   <div className="w-full flex flex-col place-items-center gap-3 mt-4 ">
    ...
    <FaqCard title={"How do I list my property for sale?"} 
    body={"To list your property for sale, click on the “List Your Property” button on our website. Follow the instructions to provide details about your property, upload photos, and set your asking price."} 
...
<FaqCard title={"What are the costs associated with selling a property?"} 
body={"The costs of selling a property may include agent commissions, closing costs, and any necessary repairs or upgrades to make your property market-ready. Our team will provide you with a detailed breakdown of these costs."}  
...
<FaqCard title={"How do I determine the value of my property?"} 
