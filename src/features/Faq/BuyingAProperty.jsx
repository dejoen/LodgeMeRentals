...
const BuyingAProperty = () =>{
   ...
   <div className="w-full flex flex-col place-items-center gap-3 mt-4 ">
    ...
    <FaqCard title={"How do I search for properties?"} 
    body={"You can search for properties using our advanced search tool. Filter results by location, price range, property type, and other criteria to find the perfect home or investment."} 
...
<FaqCard title={"Can I schedule a property tour? "} 
body={"Yes, you can schedule property tours directly through our website. Once you find a property you’re interested in, click on the “Schedule a Tour” button and choose a convenient time."}  
...
<FaqCard title={"What are the steps to buying a property? "} 
