...
const SupportAndContact = () => {
  ...
  return (
    <div className="w-full flex flex-col place-items-center gap-3 mt-4 ">
      ...
      <FaqCard
        title={"How can I contact LodgeMe?"}
        body={
      ...
      <FaqCard
        ...
        body={
          "if you experience any technical issues, please contact our support team. We are here to assist you and ensure your experience on our website is seamless."
        }
      ...
      <FaqCard
        title={"Can I get personalized assistance?"}
