...
const RentingAProperty = () =>{
   ...
   <div className="w-full flex flex-col place-items-center gap-3 mt-4 ">
    ...
    <FaqCard title={"How do I apply to rent a property?"} 
    body={"To apply for a rental property, click on the “Apply Now” button on the property listing. Fill out the application form and submit any required documents, such as proof of income and references."} 
...
<FaqCard title={"What is included in the rental application process? "} 
body={"The rental application process typically includes a background check, credit check, and verification of income and rental history. Our team will review your application and get back to you promptly."}  
...
<FaqCard title={"Can I renew my lease? "} 
