    ...
    extend: {
      backgroundImage: {
        heroSectionBackgroundImage:
          "linear-gradient(rgba(0,0,0,0.2), rgba(0,0,0,0.5)), url('../src/assets/landingPageBg.svg')",
        ...
        aboutCaptureUserImage:
          "linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.5)),url('../src/assets/aboutcaptureimage.svg')",
        blogBackgroundImage: "linear-gradient(rgba(0,0,0,0.2), rgba(0,0,0,0.5)),url('../src/assets/blogbgimage.svg')",
        copyRightBackgroundImage:
          "linear-gradient(rgba(0,0,0,0.2), rgba(0,0,0,0.5)),url('../src/assets/crbgimage.svg')",
